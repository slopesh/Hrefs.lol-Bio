      ...
      <main className="flex-1">
        ...
        >
          <div className="mx-auto max-w-5xl text-center px-4">
            <h2 className="text-4xl sm:text-5xl font-poppins font-semibold text-white mb-10">See what you can create on href.lol</h2>
            <div className="flex flex-wrap items-center justify-center gap-8">
              {/* Example bio cards */}
              {[1, 2].map((n, i) => (
                <motion.div
                  key={n}
                  className="rounded-xl overflow-hidden border border-border bg-background shadow-none hover:scale-105 transition-transform duration-200"
                  whileHover={{ scale: 1.05 }}
                  custom={i}
                  initial="hidden"
                  whileInView="visible"
                ...
                >
                  <BioCard
                    username={n === 1 ? "Aiden" : "tsoxas"}
                    avatarUrl={n === 1 ? "/images/aiden-avatar.png" : "/images/tsoxas-avatar.png"}
                    description={n === 1 ? "Owner/Dev @ E-Z Services" : "Dev @ E-Z Services"}
                    socialLinks={n === 1 ? [
                      { icon: 'user', url: '#' },
                      { icon: 'gem', url: '#' },
                      { icon: 'link', url: '#' },
                    ...
                    backgroundImage={n === 1 ? "/images/aiden-background.jpg" : "/images/tsoxas-background.jpg"}
                  />
                </motion.div>
              ))}
            </div>
            <div className="mt-12 flex justify-center">
              <a href="#features-section" onClick={handleSmoothScroll} className="text-text-secondary text-sm font-semibold font-sans hover:text-white flex items-center transition-colors duration-200">
                Learn More
