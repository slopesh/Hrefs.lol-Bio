    ...
    <div className="flex min-h-screen flex-col bg-background text-text-DEFAULT font-sans overflow-hidden">
      ...
      <main className="flex-1 py-16">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl font-poppins mb-12">Simple, transparent pricing</h1>

          {/* Pricing Tiers/Options Section */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Placeholder for Pricing Tier 1 */}
            <div className="bg-dark-200 rounded-lg p-8 border border-dark-300">
              <h2 className="text-2xl font-semibold text-white font-poppins mb-4">Free Tier</h2>
              <p className="text-text-DEFAULT font-sans mb-4">Basic features</p>
              {/* More details and a button will go here */}
              <ul className="text-text-DEFAULT text-left mb-6 space-y-2 font-sans text-sm">
                 <li>✓ Customizable bio page</li>
                 <li>✓ Unlimited links</li>
                 <li>✓ Basic analytics</li>
                 <li>✓ Standard themes</li>
              </ul>
              <p className="text-3xl font-bold text-white font-poppins">$0</p>
              <p className="text-text-secondary text-sm font-sans mb-6">forever</p>
              <div className="mt-6">
                 {/* Link or Button to Sign Up */}
                 <Link href="/register" className="btn btn-secondary w-full text-text-DEFAULT hover:text-white transition-colors duration-200 font-semibold font-poppins">Get Started</Link>
              </div>
            </div>

            {/* Placeholder for Pricing Tier 2 (e.g., Premium) */}
            <div className="bg-dark-200 rounded-lg p-8 border border-dark-300">
               <h2 className="text-2xl font-semibold text-white font-poppins mb-4">Premium</h2>
               <p className="text-text-DEFAULT font-sans mb-4">Advanced features</p>
               {/* More details and a button will go here */}
               <ul className="text-text-DEFAULT text-left mb-6 space-y-2 font-sans text-sm">
               ...
               <p className="text-3xl font-bold text-white font-poppins">$29.9</p>
               <p className="text-text-secondary text-sm font-sans mb-6">per month</p>
               <div className="mt-6">
                  {/* Link or Button to Upgrade */}
            ...
            {/* Placeholder for Invite Code Purchase */}
             <div className="bg-dark-200 rounded-lg p-8 border border-dark-300">
               <h2 className="text-2xl font-semibold text-white font-poppins mb-4">Invite Code</h2>
               <p className="text-text-DEFAULT font-sans mb-4">One-time purchase for lifetime access</p>
               {/* More details and a button will go here */}
               <ul className="text-text-DEFAULT text-left mb-6 space-y-2 font-sans text-sm">
               ...
               <p className="text-3xl font-bold text-white font-poppins">$25</p>
               <p className="text-text-secondary text-sm font-sans mb-6">lifetime</p>
               <div className="mt-6">
                  {/* Link or Button to Purchase Invite Code */}
