      ...
      <main className="flex-1 py-12 flex justify-center items-center">
        <Card className="w-full max-w-md border border-dark-300 bg-dark-200">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-white font-poppins">Login to your account</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              <Label htmlFor="identifier" className="text-text-DEFAULT font-poppins font-medium">Username or Email</Label>
              <Input id="identifier" type="text" className="font-sans" />
            </div>
            <div className="grid gap-2">
          ...
          <CardFooter className="flex flex-col gap-4">
             ...
             <p className="text-center text-sm text-text-DEFAULT font-sans">
               Don't have an account? <Link href="/register" className="text-primary-400 font-poppins font-semibold hover:underline">Register</Link>
             </p>
          </CardFooter>
        </Card>
      </main>
