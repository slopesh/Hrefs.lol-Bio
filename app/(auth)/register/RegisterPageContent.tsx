...
import dynamic from 'next/dynamic'; // Keep dynamic here if ClientMotionWrapper is defined here

// Dynamically import the motion wrapper with SSR disabled (Keep this here)
const ClientMotionWrapper = dynamic(() => import('@/components/client-motion-wrapper'), {
  ssr: false,
  loading: () => <div className="w-full max-w-md"></div>,
});

// export const metadata: Metadata = { ... } // Metadata should stay in the page.tsx file

export default function RegisterPageContent() { // Changed function name and export
  return (
